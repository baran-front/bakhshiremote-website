...
function AccordionItem({
  ...
  return (
    <AccordionPrimitive.Item
      ...
      className={cn("bg-card rounded-2xl p-6 max-h-max border-2 border-transparent hover:border-primary shadow-2xl shadow-transparent hover:shadow-primary/30 data-[state=open]:border-primary data-[state=open]:shadow-primary/30", className)}
      {...props}
    />
  );
}
