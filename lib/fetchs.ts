...
export const getArticleDetail = (params: GetArticleDetailParamsT) =>
  safeFetch<{ data: ArticleT }>(`/v1/blogposts/${params.id}`, {});
...
export const postContactUs = (params: PostContactUsParamsT) =>
  safeFetch<{ data: number }>("/v1/contactusmessages", {
    method: "POST",
    headers: CommonHeaders.jsonApplicationType,
    body: JSON.stringify(params),
  });
...
export const postBookmark = (params: PostBookmarkParamsT) =>
...
export const postComment = (params: PostCommentParamsT) =>
